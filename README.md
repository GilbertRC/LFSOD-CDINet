...
Note: We provide a modified [layer.py](https://pan.baidu.com/s/18d5XrK3LlIGjbWWsCFLVog) (code: 7d8i) for TensorFlow. The added function 'layer_norm_initialized()' enables initializing Layer_Norm with the pre-trained parameters.
