...
Note: We provide a modified [layer.py](https://pan.baidu.com/s/18d5XrK3LlIGjbWWsCFLVog) (code: 7d8i) for TensorFlow 1.x. It adds a function 'layer_norm_initialized()' to initialize Layer_Norm with the pre-trained parameters.
