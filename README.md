...
Note: The default TensorFlow 1.x cannot initialize Layer_Norm with the pre-trained parameters, so we add a function layer_norm_initialized() in the layer.py.
